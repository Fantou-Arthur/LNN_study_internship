...
parser = argparse.ArgumentParser(description="CNN Modern Demo with Fix")
...
print(f"{C_BOLD}Device:{C_END} {C_GREEN}{device}{C_END} | {C_BOLD}Filters:{C_END} {num_units} | {C_BOLD}Layers:{C_END} {num_layers} | {C_BOLD}Dataset:{C_END} {C_YELLOW}{dataset_name}{C_END}")
